...
int main(int argc, char* argv[])
{
    ...
    const std::vector<HttpServer>& servers = cluster.getServers(); // You might need to add a getter for this
    ...
    for (std::vector<HttpServer>::const_iterator it = servers.begin();
        ...
        displayServerInfo(it->getConfig()); // You might need to add a getter for _config
    }
